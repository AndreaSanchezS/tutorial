		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#accenturetutorial1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"accenturetutorial1-display": {
								"semanticObject": "accenturetutorial1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=accenture.tutorial1",
									"url": sap.ui.require.toUrl("accenture/tutorial1")
								}
							}
						}
					}
